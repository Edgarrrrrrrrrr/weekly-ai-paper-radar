# Weekly Paper Radar | 2026 第 27 周
...
| 排名 | 论文 | 来源 | 发布时间 | 为什么值得看 | 原文 | 精读 |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | From Detection to Action: Using LLM Agents for Fault-Tolerant Control | arXiv | 2026-06-26 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生视频 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2606.28011v1) / [PDF](https://arxiv.org/pdf/2606.28011v1) | [阅读精读](papers/2606-28011v1-from-detection-to-action-using-llm-agents-for-fault-tolerant-control.md) |
| 2 | Grounded Iterative Language Planning: How Parameterized World Models Reduce Hallucination Propagation in LLM Agents | arXiv | 2026-06-26 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生视频 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2606.27806v1) / [PDF](https://arxiv.org/pdf/2606.27806v1) | [阅读精读](papers/2606-27806v1-grounded-iterative-language-planning-how-parameterized-world-models-redu.md) |
