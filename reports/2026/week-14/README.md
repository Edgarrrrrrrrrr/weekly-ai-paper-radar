# Weekly Paper Radar | 2026 第 14 周
...
| 2 | LogiStory: A Logic-Aware Framework for Multi-Image Story Visualization | arXiv | 2026-03-30 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生图 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2603.28082v1) / [PDF](https://arxiv.org/pdf/2603.28082v1) | [阅读精读](papers/2603-28082v1-logistory-a-logic-aware-framework-for-multi-image-story-visualization.md) |
| 3 | Coherent Without Grounding, Grounded Without Success: Observability and Epistemic Failure | arXiv | 2026-03-30 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生图 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2603.28371v1) / [PDF](https://arxiv.org/pdf/2603.28371v1) | [阅读精读](papers/2603-28371v1-coherent-without-grounding-grounded-without-success-observability-and-ep.md) |
...
| 排名 | 论文 | 来源 | 发布时间 | 为什么值得看 | 原文 | 精读 |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | VistaGEN: Consistent Driving Video Generation with Fine-Grained Control Using Multiview Visual-Language Reasoning | arXiv | 2026-03-30 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生视频 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2603.28353v1) / [PDF](https://arxiv.org/pdf/2603.28353v1) | [阅读精读](papers/2603-28353v1-vistagen-consistent-driving-video-generation-with-fine-grained-control-u.md) |
