# Autonomous Canvas Agents for Text-to-Image Editing Workflows
...
| 原文入口 | [Abstract](http://arxiv.org/abs/2603.00011v1) |
| PDF | [Download PDF](http://arxiv.org/pdf/2603.00011v1) |
...
We study a text-to-image and image editing system where an agent plans multi-step tool use, prompt rewriting, and region-level drawing actions to improve controllable visual generation.
