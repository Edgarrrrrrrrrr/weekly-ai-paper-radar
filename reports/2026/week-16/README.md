# Weekly Paper Radar | 2026 第 16 周
...
这个方向正在从单纯的视频生成走向可交互环境、世界模型和长时序控制，为 Agent 提供训练与模拟空间。 本期可以重点留意：CT-1: Vision-Language-Camera Models Transfer Spatial Reasoning Knowledge to Camera-Controllable Video Generation；FloVD: Optical Flow Meets Video Diffusion Model for Enhanced Camera-Controlled Video Synthesis。
...
| 排名 | 论文 | 来源 | 发布时间 | 为什么值得看 | 原文 | 精读 |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | CT-1: Vision-Language-Camera Models Transfer Spatial Reasoning Knowledge to Camera-Controllable Video Generation | arXiv | 2026-04-10 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生视频 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2604.09201v1) / [PDF](https://arxiv.org/pdf/2604.09201v1) | [阅读精读](papers/2604-09201v1-ct-1-vision-language-camera-models-transfer-spatial-reasoning-knowledge.md) |
...
| 3 | Toward World Models for Epidemiology | arXiv | 2026-04-10 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生视频 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2604.09519v1) / [PDF](https://arxiv.org/pdf/2604.09519v1) | [阅读精读](papers/2604-09519v1-toward-world-models-for-epidemiology.md) |
