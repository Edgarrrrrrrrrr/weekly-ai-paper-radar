# Weekly Paper Radar | 2026 第 15 周
...
| 2 | CAMEO: A Conditional and Quality-Aware Multi-Agent Image Editing Orchestrator | arXiv | 2026-04-03 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生图 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2604.03156v1) / [PDF](https://arxiv.org/pdf/2604.03156v1) | [阅读精读](papers/2604-03156v1-cameo-a-conditional-and-quality-aware-multi-agent-image-editing-orchestr.md) |
| 3 | Visual Instruction-Finetuned Language Model for Versatile Brain MR Image Tasks | arXiv | 2026-04-03 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生图 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2604.02748v1) / [PDF](https://arxiv.org/pdf/2604.02748v1) | [阅读精读](papers/2604-02748v1-visual-instruction-finetuned-language-model-for-versatile-brain-mr-image.md) |
...
| 排名 | 论文 | 来源 | 发布时间 | 为什么值得看 | 原文 | 精读 |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Hierarchical Planning with Latent World Models | arXiv | 2026-04-03 | 这是这个方向近期更值得跟踪的新工作之一，它同时命中了 文生视频 + Agentic AI 的关键特征。 | [Abstract](http://arxiv.org/abs/2604.03208v1) / [PDF](https://arxiv.org/pdf/2604.03208v1) | [阅读精读](papers/2604-03208v1-hierarchical-planning-with-latent-world-models.md) |
